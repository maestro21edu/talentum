...
if (theme_get_option('theme_override_default_footer_content')) {
    ...
    theme_add_sidebar('footer', 'footer-4-widget-area', __('Footer 4 Widget Area', THEME_NS), __("The custom footer widget area.", THEME_NS));
    theme_add_sidebar('footer', 'footer-5-widget-area', __('Footer 5 Widget Area', THEME_NS), __("The custom footer widget area.", THEME_NS));
}
